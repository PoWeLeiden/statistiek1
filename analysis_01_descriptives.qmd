...
De meest gebruikte centrummaten zijn het gemiddelde, de mediaan en de modus. Om te tonen hoe we ze berekenen met R, zullen we de drie variabelen gebruiken:
...
Zoals hierboven uitgelegd, gebruik je het symbool "\$" om variabelen in dataframes aan te roepen. Daarom, als we een van de functies willen gebruiken die tot nu toe zijn behandeld (`mean()`, `table()`, `sd()`, `var()`, enz.) gebruik je gewoon die operator om specifieke variabelen in data frames te gebruiken.
